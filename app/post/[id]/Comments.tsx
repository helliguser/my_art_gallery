      ...
      {userId ? (
        <form onSubmit={handleSubmit} style={{ marginBottom: '1rem' }}>
          <textarea
            ...
            rows={3}
            style={{ width: '100%', padding: '0.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.15)', background: 'rgba(0,0,0,0.3)', color: 'white' }}
          />
          <button
            type="submit"
            disabled={submitting}
          ...
          >
            <div style={{ display: 'flex', gap: '0.5rem', flex: 1 }}>
              ...
              <div>
                <div>
                  <b>{authorName}</b>
                  <small style={{ marginLeft: '0.5rem', color: '#999' }}>
            ...
            {canDelete && (
              ...
              >
                <Icon name="Trash_Full" folder="interface" size={16} />
              </button>
            )}
          </div>
        );
